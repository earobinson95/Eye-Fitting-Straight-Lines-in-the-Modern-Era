...
Participants completed the experiment on their own computers in an environment of their choosing. The experiment was conducted and distributed through a Shiny application [@shinyPkg] \ear{xxx added citation} found [here](https://emily-robinson.shinyapps.io/you-draw-it-pilot-app/). \svp{We should probably make a rstudioconnect version that saves data to e.g. a google spreadsheet? Just in case my server goes down or something?} \ear{XXX currently linked to my shinyapps.io page but will get this updated to a new repository.}
