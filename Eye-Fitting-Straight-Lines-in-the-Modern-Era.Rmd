...
eyefitting_example_sim <- read.csv(here("analysis/eyefitting-simulated-data.csv"))
...
Fitted values, $\hat y_{k,PCA}$, were then obtained every 0.25 increment across the domain from the PCA regression equation, $\hat y_{k,PCA} = \hat\beta_{0,PCA} + \hat\beta_{1,PCA} x_k$, for $k = 1, ..., 4 x_{max} +1$.
