...
@unwin2020data defines data visualization as the art of graphic displays to show data. 
...
When creating a graphic, we must consider the design choices most effective for conveying the intended result.
