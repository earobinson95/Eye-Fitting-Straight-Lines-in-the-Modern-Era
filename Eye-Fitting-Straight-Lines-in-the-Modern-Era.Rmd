...
```{r eyefitting-parameters}
          data.frame(Parm = c("F", "N", "S", "V"),
            ...
            mutate(Parm = factor(Parm, levels = c("F", "S", "V", "N"))) %>%
            arrange(Parm) %>%
            knitr::kable("latex", 
                         digits = 2, 
                         escape = F, 
